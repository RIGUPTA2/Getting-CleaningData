...
# set the value of the variable assignmentPath to be the location where run_analysis.R is created
assignmentPath <- "C:/Users/IBM_ADMIN/Desktop/LocalRepository/DataScience/3_GettingAndCleaningData/Assignment1/"
setwd(assignmentPath)

# Getting data
# Take this url from the assignment link
dataURL <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
dataZipFolder <- "UCI_Data.zip"
download.file(dataURL,dataZipFolder,"curl")
unzip(dataZipFolder)
...
projectDataPath <- file.path(path, dataDir)
